...
export function BlogProvider({ children }) {
  ...
  const [blogsWithoutPaginationData, setBlogsWithoutPaginationData] = useState(
    initialBlogsWithoutPaginationData
  );
  const {
    user,
    token,
    ...
    try {
      ...
      const commentArr = response.data?.data?.map((comment) => {
        return {
          ...
          profilePictureId:
            comment?.attributes?.user?.data?.attributes?.profile?.data
              ?.attributes?.profilePicture?.data?.id,
          description: comment?.attributes?.description,
          commentDate: comment?.attributes?.commentDate,
          userProfileId:
            comment?.attributes?.user?.data?.attributes?.profile?.data?.id,
          firstName:
            comment?.attributes?.user?.data?.attributes?.profile?.data
    ...
    try {
      ...
      const blogArray = response.data?.data?.map((data) => {
        return {
          ...
          profileId:
            data?.attributes?.author?.data?.attributes?.profile?.data?.id,
          categories: data?.attributes?.categories?.data,
          likes: data?.attributes?.likes?.data,
          profilePictureId:
            data?.attributes?.author?.data?.attributes?.profile?.data
              ?.attributes?.profilePicture?.data?.id,
          ...
          facebookAccount:
            data?.attributes?.author?.data?.attributes?.profile?.data
              ?.attributes?.facebookAccount,
          googlePlusAccount:
            data?.attributes?.author?.data?.attributes?.profile?.data
              ?.attributes?.googlePlusAccount,
          instagramAccount:
            data?.attributes?.author?.data?.attributes?.profile?.data
              ?.attributes?.instagramAccount,
          linkedinAccount:
            data?.attributes?.author?.data?.attributes?.profile?.data
              ?.attributes?.linkedinAccount,
          twitterAccount:
            data?.attributes?.author?.data?.attributes?.profile?.data
              ?.attributes?.twitterAccount,
          website:
            data?.attributes?.author?.data?.attributes?.profile?.data
              ?.attributes?.website,
          profilePicture:
  ...
  const createBlog = async (data, des) => {
    ...
    try {
      ...
      const response = await axiosPrivateInstance(token).post(
        ...
        formData,
        {
          onUploadProgress: (progress) => {
            const percentageData = uploadPercentage(
              progress.total,
              progress.loaded
            );
      ...
      const blogs_data = {
        ...
        profileId:
          response.data.data?.attributes?.author?.data?.attributes?.profile
            ?.data?.id,
        profilePictureId:
          response.data.data?.attributes?.author?.data?.attributes?.profile
            ?.data?.attributes?.profilePicture?.data?.id,
        categories: response.data.data?.attributes?.categories?.data,
        likes: response.data.data?.attributes?.likes?.data,
        title: response.data.data?.attributes?.title,
        description: response.data.data?.attributes?.description,
        blog_image:
          response.data.data?.attributes?.blog_image?.data?.attributes?.url,
        ...
        facebookAccount:
          response.data.data?.attributes?.author?.data?.attributes?.profile
            ?.data?.attributes?.facebookAccount,
        googlePlusAccount:
          response.data.data?.attributes?.author?.data?.attributes?.profile
            ?.data?.attributes?.googlePlusAccount,
        instagramAccount:
          response.data.data?.attributes?.author?.data?.attributes?.profile
            ?.data?.attributes?.instagramAccount,
        linkedinAccount:
          response.data.data?.attributes?.author?.data?.attributes?.profile
            ?.data?.attributes?.linkedinAccount,
        twitterAccount:
          response.data.data?.attributes?.author?.data?.attributes?.profile
            ?.data?.attributes?.twitterAccount,
        website:
          response.data.data?.attributes?.author?.data?.attributes?.profile
            ?.data?.attributes?.website,
        profilePicture:
          response.data.data?.attributes?.author?.data?.attributes?.profile
            ?.data?.attributes?.profilePicture?.data?.attributes?.url,
      };
      setTrigger(!trigger);
