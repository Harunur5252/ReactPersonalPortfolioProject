...
import {
  aboutDesVariants,
  aboutPersonaInfoVariants,
  aboutPersonaVideoInfoVariants,
} from "../components/AboutSectionComponents/AnimationData";

function About() {
  const { about, colorData } = useContext(PageContext);
          ...
          <div className="about_one">
            <div className="row">
              <motion.div
                ...
                variants={aboutPersonaInfoVariants}
                animate={controls}
                initial="hidden"
              >
              ...
              <motion.div
                ...
                variants={aboutPersonaVideoInfoVariants}
                animate={controls}
                initial="hidden"
              >
                <PersonalVideo />
