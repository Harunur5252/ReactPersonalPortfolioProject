  ...
  const deleteProfileImage = async () => {
    try {
      ...
      const response = await axiosPrivateInstance(token).delete(
        `upload/files/${singleProfile?.imgId}`
      );
      console.log(response.data);
      toast.success(
        "Before profile image is deleted successfully,now update with new image!"
      );
  ...
  const handleProfileUpdate = async (evt) => {
    ...
    try {
      if (
        ...
        setImageError({
          error:
            "You have already an image,if you want to update then delete before image",
        });
        ...
        const response = await axiosPrivateInstance(token).put(
          `/profiles/${singleProfile?.profileId}`,
          formData
        );
        setImageError({
          error: "",
          ...
          <div className="row">
            ...
            <div className="col-md-6 col-lg-6">
              <div className="form-group">
                ...
                {profileSubmit && (
                  <BarLoader color="#36d7b7" height={8} width={470} />
                )}
                {profileSubmit && (
                  <p
                    style={{
              ...
              <div className="form-group">
                <input
                  ...
                  {...register("facebookAccount", {
                    required: "facebookAccount link is required",
                  })}
              ...
              <div className="form-group">
                <input
                  ...
                  {...register("twitterAccount", {
                    required: "twitterAccount link is required",
                  })}
            ...
            <div className="col-md-6 col-lg-6">
              <div className="form-group">
                <input
                  className="form-control"
                  type="text"
                  {...register("googlePlusAccount", {
                    required: "googlePlusAccount link is required",
                  })}
                  placeholder="Enter Your googlePlusAccount Link"
                  defaultValue={googlePlusAccount}
                />
                <span style={{ color: "red" }}>
                  {errors?.googlePlusAccount?.message}
                </span>
              </div>
            </div>
            <div className="col-md-6 col-lg-6">
              <div className="form-group">
                <input
                  ...
                  {...register("instagramAccount", {
                    required: "instagramAccount link is required",
                  })}
              ...
              <div className="form-group">
                <input
                  ...
                  {...register("linkedinAccount", {
                    required: "linkedinAccount link is required",
                  })}
                  placeholder="Enter Your linkedinAccount Link"
                  defaultValue={linkedinAccount}
                />
                <span style={{ color: "red" }}>
                  {errors?.linkedinAccount?.message}
                </span>
              </div>
            </div>
      ...
      <table className="table table-responsive table-striped table-dark table-hover table-borderless">
        ...
        {profileSubmit ? (
          ...
          <tbody>
            <tr>
              <td>
                {singleProfile?.profileId ? (
                  singleProfile?.profileId
                ) : (
                  <span
                    style={{
                      color: "rgba(208, 213, 17, 0.8)",
                      fontSize: "1rem",
                    }}
                  >
                    no id
              ...
              <td>
                <img
                  ...
                  style={{ height: "107px", width: "156px" }}
                  alt="notFoundImage"
                />
              </td>
              {singleProfile?.profileId && singleProfile?.userId && (
              ...
              >
                <div className="form-group">
                  <input
                    ...
                    defaultValue={singleProfile?.firstName}
                    name="firstName"
                    className="form-control"
                ...
                <div className="form-group">
                  <input
                    type="text"
                    onChange={handleChange}
                    defaultValue={singleProfile?.lastName}
                    name="lastName"
                    className="form-control"
                    id="exampleInputEmail1"
                    aria-describedby="emailHelp"
                  ...
                  <div className="row mt-3">
                    ...
                    <div className="col-lg-5">
                      <button
                        ...
                        type="submit"
                        disabled={
                          profileDeleteImg || !singleProfile?.imgId
                            ? "disabled"
                            : ""
                        }
                ...
                <div className="form-group">
                  <input
                    ...
                    defaultValue={singleProfile?.facebookAccount}
                    className="form-control"
                    id="exampleInputPassword1"
                ...
                <div className="form-group">
                  <input
                    ...
                    onChange={handleChange}
                    name="twitterAccount"
                    defaultValue={singleProfile?.twitterAccount}
                    className="form-control"
                    id="exampleInputPassword1"
                ...
                <div className="form-group">
                  <input
                    type="text"
                    onChange={handleChange}
                    name="googlePlusAccount"
                    defaultValue={singleProfile?.googlePlusAccount}
                    className="form-control"
                    id="exampleInputPassword1"
                ...
                <div className="form-group">
                  <input
                    ...
                    defaultValue={singleProfile?.instagramAccount}
                    className="form-control"
                    id="exampleInputPassword1"
                ...
                <div className="form-group">
                  <input
                    ...
                    defaultValue={singleProfile?.linkedinAccount}
                    className="form-control"
                    id="exampleInputPassword1"
